...
/**
 * Created by Vijay on 8/10/2018. Test for WestPac User Story 1 As a Product
 * Owner If there is no amount entered and the convert button is clicked then I
 * want to see an error message “Please enter the amount you want to convert.”
 * on the currency converter page. So that user is able to get a clear
